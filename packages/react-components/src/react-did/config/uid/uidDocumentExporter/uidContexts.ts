/**
 * IPFS URL identifying a JSON-LD context file describing terms used in DID documents of the UID method that are not defined in the W3C DID core context.
 * Should be the second entry in the ordered set of contexts after [[W3C_DID_CONTEXT_URL]] in the JSON-LD representation of a UID DID document.
 */
export const UID_DID_CONTEXT_URL =
...
/**
 * URL identifying a JSON-LD context file proposed by the W3C Credentials Community Group defining a number of terms which are used in verification methods on UID DID documents.
 * See https://w3c-ccg.github.io/security-vocab/.
 * This document is extended by the context file available under the [[UID_DID_CONTEXT_URL]].
 */
export const W3C_SECURITY_CONTEXT_URL = 'https://w3id.org/security/v2';
/**
 * An object containing static copies of JSON-LD context files relevant to UID DID documents, of the form <context URL> -> context.
...
export const DID_CONTEXTS = {
  [UID_DID_CONTEXT_URL]: {
    '@context': [
      ...
      {
        '@protected': true,
        UidPublishedCredentialCollectionV1Type:
